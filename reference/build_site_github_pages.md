...
- Runs
  [`build_site()`](https://pkgdown.r-lib.org/reference/build_site.md) in
  process.
...
- new_process:
  ...
  If `TRUE`, will run
  [`build_site()`](https://pkgdown.r-lib.org/reference/build_site.md) in
  a separate process. This enhances reproducibility by ensuring nothing
  that you have loaded in the current process affects the build process.
