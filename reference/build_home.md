...
[`init_site()`](https://pkgdown.r-lib.org/reference/init_site.md) will
also automatically create a favicon set from your package logo.
...
[`?build_site`](https://pkgdown.r-lib.org/reference/build_site.md) for
details about changing the location of the authors information within
the home sidebar and the site footer.
...
`?build_home`/[`?build_site`](https://pkgdown.r-lib.org/reference/build_site.md),
respectively).
