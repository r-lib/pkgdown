...
test_that("og tags are populated on index.html", {
  index_html <- readLines(file.path(pkg$dst_path, "index.html"))
...
test_that("og tags are populated on reference pages", {
  pork_html <- readLines(file.path(pkg$dst_path, "reference", "pulledpork.html"))
...
test_that("og tags are populated on vignettes", {
  vignette_html <- readLines(file.path(pkg$dst_path, "articles", "open-graph.html"))
