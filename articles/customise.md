...
and [`init_site()`](https://pkgdown.r-lib.org/reference/init_site.md).
...
[`vignette("accessibility")`](https://pkgdown.r-lib.org/articles/accessibility.md)
...
complete site with
[`build_site()`](https://pkgdown.r-lib.org/reference/build_site.md) to
fully appreciate the changes. While you’re experimenting, you can speed
things up by just rebuilding the home page and the CSS by running
[`build_home_index()`](https://pkgdown.r-lib.org/reference/build_home.md);
[`init_site()`](https://pkgdown.r-lib.org/reference/init_site.md) (and
...
[`build_home_index(); init_site()`](https://pkgdown.r-lib.org/reference/build_home.md)
...
[`?build_home`](https://pkgdown.r-lib.org/reference/build_home.md) for
how to customise the sidebar on the homepage. They all use a similar
...
- `developed_by`: a sentence describing the main authors of the package.
  (See
  [`?build_home`](https://pkgdown.r-lib.org/reference/build_home.md) if
  you want to tweak *which* authors appear in the footer.)
...
Use [`init_site()`](https://pkgdown.r-lib.org/reference/init_site.md) to
