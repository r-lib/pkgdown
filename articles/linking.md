...
- Calls to `?`, like
  [`?build_site`](https://pkgdown.r-lib.org/reference/build_site.md) or
  [`package?pkgdown`](https://pkgdown.r-lib.org/reference/pkgdown-package.md).
- Calls to [`help()`](https://rdrr.io/r/utils/help.html), like
  [`help("pkgdown")`](https://pkgdown.r-lib.org/reference/pkgdown-package.md).
