# Currently three separate flows:
# * syntax_highlight which is used in examples
# * autolink_html which is used elsewhere
#   * two variants (strict & not)
# * as_html.tag_code which just links vignette calls
