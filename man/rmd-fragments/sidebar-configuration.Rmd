...
-   `dev`: development status badges found in `README.md`/`index.md`. *This section is automatically removed for websites of released versions (For all development modes, the badges are removed from the main content. See "Development mode" in `?build_site` for a summary of when badges are shown in the sidebar as opposed to not shown anywhere on the home page)*
