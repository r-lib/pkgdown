...
-   `dev`: development status badges found in `README.md`/`index.md`. *This section is automatically removed for websites of released versions (see "Development mode" in `?build_site`. For all development modes, the badges are removed from the main content.*
