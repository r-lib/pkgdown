...
You can also customise the color scheme of the navbar by using the [`type` and `bg` parameters](https://getbootstrap.com/docs/4.0/components/navbar/#color-schemes). See `vignette("customise")` for more details.
