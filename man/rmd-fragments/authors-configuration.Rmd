...
filtering of authors for the sidebar and footer, and display of authors.
...
You can modify the authors'
display on the home page and author page by adding a subsection for `authors`. 
Each entry
