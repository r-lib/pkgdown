...
-   `pkgdown/extra.css` and `pkgdown/extra.js` will be copied to the destination directory and linked from `<head>` (after the pkgdown defaults).

-   `pkgdown/extra.scss` will be added to the scss ruleset used to generate the site CSS.

-   Any additional files in `pkgdown/assets` will be copied to the destination directory.
