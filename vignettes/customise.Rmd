...
You can use the dark mode introduced in [Bootstrap v5.3](https://getbootstrap.com/docs/5.3/customize/color-modes/) in your pkgdown site by making a few changes to your configuration. pkgdown contains changes to `pkgdown.js` and `pkgdown.css` to enable dark mode.

Modify your `_pkgdown.yml` configuration file with:
...
See the [pkgdown](https://pkgdown.r-lib.org/) and [bslib](https://rstudio.github.io/bslib/) websites for examples of dark mode (toggle in the upper right).
