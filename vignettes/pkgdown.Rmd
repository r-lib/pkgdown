...
*   Customize metadata used by Twitter and the [Open Graph protocol](https://ogp.me/)
    for rich social media cards. Store social media card preview images in
    `man/figures/` 
    ...
    template:
      opengraph:
        image: 
          ...
          alt: "A card image for my package"
        twitter: 
