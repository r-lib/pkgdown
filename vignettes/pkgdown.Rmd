...
*   If you want to track the people who are using your site, either a
    
    -   [GoatCounter](https://www.goatcounter.com/) endpoint
    ...
    -   or a [Google Analytics](https://marketingplatform.google.com/about/analytics/) user ID 
...
Once your site is online you must finish configuring it by adding its URL to its configuration file.
This URL will be used by pkgdown to e.g. generate the metadata correcty (see `vignette("metadata")`).
