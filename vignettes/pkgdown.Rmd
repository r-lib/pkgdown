...
*   A [`bootswatch`](https://bootswatch.com) theme that affects the overall
  ...
  For Boostrap version 3 the syntax is
...
This URL will be used by pkgdown to e.g. generate the metadata correcty (see `vignette("metadata")`) -- refer to `?build_site` for reading about more functionalities that needs the URL to be stored in the configuration file.
