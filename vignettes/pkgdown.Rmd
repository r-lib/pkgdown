...
`home`, if different from the DESCRIPTION Title.

* The homepage "og:description" as a `description` subcomponent of `home`, if different from the DESCRIPTION Description
