...
This URL will be used by pkgdown to e.g. generate the metadata correcty (see `vignette("metadata")`). See `?build_site` for other effects of specifying this important parameter.
