...
To build a pkgdown site, run `pkgdown::build_site()`.
...
By default, the top navigation bar ("navbar") will contain links to:
...
See more suggestions for writing news bullets in the [tidyverse style guide](http://style.tidyverse.org/news.html). 
