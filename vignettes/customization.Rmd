...
If you e.g. need an SVG used by your CSS, Store the files under `inst/pkgdown/assets/BS4` (if you're using Bootstrap 4), it will be copied to the root of your website folder by pkgdown (by `init_site()`).
## Layout
