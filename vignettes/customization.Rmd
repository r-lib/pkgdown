...
For any template for which you have not provided a replacement, pkgdown will use the default template (corresponding to the right Bootstrap version).
...
* To find what template to edit, study the contents of pkgdown's templates folder (`inst/templates/BS4` for Bootstrap 4, `inst/templates/BS3` for Bootstrap 3).
* Create a folder `inst/pkgdown/templates` (or use another method to override templates).
