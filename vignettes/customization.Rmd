...
theme_vars <- 
  ...
  mutate(Variable = paste0("<code>", Variable, "</code>"),
         Sass = paste0("<code>", Sass, "</code>"))
```

```{r echo=FALSE}
reactable(theme_vars, 
          groupBy = "Variable", 
...
extra_vars <- 
  ...
  mutate(Variable = paste0("<code>", Variable, "</code>"),
         Overrides = paste0("<code>", Overrides, "</code>"))
```
