...
```{r navbar-fragment, results='asis', echo=FALSE}
content <- readLines("../man/rmd-fragments/navbar-configuration.Rmd")
cat(
  paste0(
    content[-1],
    collapse = "\n"
...
```{r footer-fragment, results='asis', echo=FALSE}
content <- readLines("../man/rmd-fragments/footer-configuration.Rmd")
cat(
  paste0(
    content[-1],
    collapse = "\n"
