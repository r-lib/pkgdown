...
* Call `usethis::use_pkgdown_github_pages()`. This is safe and a good idea even
  if you are already using pkgdown + GitHub Pages + GitHub Actions. It will:
...
Automatic development mode is recommended for packages with a broad user base, because it decreases the chance a user will read documentation for a version different from the version they have installed.
...
<https://www.tidyverse.org/blog/2021/12/pkgdown-2-0-0/>
