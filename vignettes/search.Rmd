...
We'd recommend switching to Bootstrap 4, see `vignette("customise")`.
...
Note that the search won't work locally if you simply use pkgdown preview of the static files.
...
Once this configuration is complete, you should find a search bar after re-building your site. After the search is enabled, pressing `shift` + `/` (i.e., "?") will move the focus to the search bar.
