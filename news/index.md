...
- Links to favicons in page headers were updated to reflect changes to
  ...
  [`pkgdown::build_favicons()`](https://pkgdown.r-lib.org/reference/build_favicons.md).
...
- New [`clean_cache()`](https://pkgdown.r-lib.org/reference/clean.md)
...
- [`build_articles()`](https://pkgdown.r-lib.org/reference/build_articles.md)
  ...
  [`vignette("quarto")`](https://pkgdown.r-lib.org/articles/quarto.md)([\#2210](https://github.com/r-lib/pkgdown/issues/2210)).
...
- New
  [`vignette("translations")`](https://pkgdown.r-lib.org/articles/translations.md)
...
- [`build_home()`](https://pkgdown.r-lib.org/reference/build_home.md) no
  longer checks if the README is missing any images. This check is now
  performed in
  [`build_site()`](https://pkgdown.r-lib.org/reference/build_site.md),
  after
  [`build_articles()`](https://pkgdown.r-lib.org/reference/build_articles.md)
...
- [`init_site()`](https://pkgdown.r-lib.org/reference/init_site.md) will
  no longer automatically build favicons on CI systems (e.g. GHA). This
  is an expensive operation that uses an external service so it should
  only be run locally
  ([\#2553](https://github.com/r-lib/pkgdown/issues/2553)).

- [`init_site()`](https://pkgdown.r-lib.org/reference/init_site.md) once
  again describes one copy per line, and now uses a better prefix when
  copying assets from pkgdown itself
  ([\#2445](https://github.com/r-lib/pkgdown/issues/2445)).

- [`pkgdown_sitrep()`](https://pkgdown.r-lib.org/reference/check_pkgdown.md)/[`check_pkgdown()`](https://pkgdown.r-lib.org/reference/check_pkgdown.md)
...
- [`build_home()`](https://pkgdown.r-lib.org/reference/build_home.md) no
  longer errors when you have an empty `.md` file
...
- [`build_home()`](https://pkgdown.r-lib.org/reference/build_home.md) no
  longer shows development status badges on the released version of the
  site ([\#2054](https://github.com/r-lib/pkgdown/issues/2054)).
...
- New
  [`pkgdown_print()`](https://pkgdown.r-lib.org/reference/pkgdown_print.md)
...
- [`build_site_github_pages()`](https://pkgdown.r-lib.org/reference/build_site_github_pages.md)
  ...
  [`deploy_site_github()`](https://pkgdown.r-lib.org/reference/deploy_site_github.md)
...
- The 404 page (default or from `.github/404.md`) is no longer built in
  ...
  [`?build_site`](https://pkgdown.r-lib.org/reference/build_site.md)) as
  e.g. GitHub pages only uses the `404.html` in the site root
...
- [`build_news()`](https://pkgdown.r-lib.org/reference/build_news.md) no
  longer breaks with URLs containing numeric fragments
...
- [`build_home()`](https://pkgdown.r-lib.org/reference/build_home.md) no
  longer uses (unrendered) `README.Rmd` or `index.Rmd` if corresponding
  `.md` files are not found.
...
- `CNAME` is no longer generated by
  [`init_site()`](https://pkgdown.r-lib.org/reference/init_site.md), but
  is instead conditionally by
  [`deploy_to_branch()`](https://pkgdown.r-lib.org/reference/deploy_to_branch.md)
...
- [`build_reference()`](https://pkgdown.r-lib.org/reference/build_reference.md)
  ...
  [`build_home()`](https://pkgdown.r-lib.org/reference/build_home.md) no
  longer re-builds `README.Rmd` or `index.Rmd`. This makes the scope of
...
- [`rd2html()`](https://pkgdown.r-lib.org/reference/rd2html.md) is now
...
- [`init_site()`](https://pkgdown.r-lib.org/reference/init_site.md) now
  creates a CNAME file if one doesn’t already exist and the site’s
...
- Similarly,
  [`build_news()`](https://pkgdown.r-lib.org/reference/build_news.md) no
  longer takes a `one_page` argument; this should now be specified in
