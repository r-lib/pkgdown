...
# pkgdown `r if(knitr::opts_knit$get('rmarkdown.pandoc.to')=='gfm-ascii_identifiers') '<img src="man/figures/logo.png" align="right" alt="" />'`
...
As at last count, pkgdown is used [by over 2000 packages](https://github.com/search?o=desc&q=pkgdown.css+in%3Apath+path%3Adocs&s=indexed&type=Code). 
